...
import { BackOfficeLocationFormProps } from '@/Utils/types'

import React, { useState } from 'react'
import toast from 'react-hot-toast'

export const BackOfficeLocationForm: React.FC<BackOfficeLocationFormProps> = ({
    handleClose,
}) => {
    ...
    const handleSubmit = () => {
        if (name) {
            ...
            setError('Veuillez entre le nom du secteur')
        }
    }
