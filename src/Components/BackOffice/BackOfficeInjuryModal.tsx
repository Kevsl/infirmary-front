...
import { BackOfficeInjuryForm } from './BackOfficeInjuryForm'
...
export const BackOfficeInjuryModal = ({ title }: { title: string }) => {
    ...
    return (
        <div>
            ...
            >
                <Box sx={style}>
                    <BackOfficeInjuryForm handleClose={handleClose} />
                </Box>
            </Modal>
        </div>
    )
